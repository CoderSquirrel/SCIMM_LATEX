...
\section{O Sistema}
		 ...
		 Apos a execução de toda o sistema é finalizada, como mostra o diagrama de fluxo na Figura \ref{FlowCHart}.
		...
		A rotina de calibração possui cinco etapas e os mesmos possuem o mínimo de interação possível do usuário. Nas subseções à seguir explicarei detalhadamente cada uma das etapas do processo de calibração automática.
