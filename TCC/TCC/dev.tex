	...
	Neste capítulo se apresenta toda a descrição do sistema proposto. Na seção 3.1 s\~ao descritas as tecnologias usadas no projeto juntamente com um breve contexto sobre cada. A seç\~ao 4.2 contem a organização do projeto, bem como suas classes, e a funcionalidade de cada uma.
