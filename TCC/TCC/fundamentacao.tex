...
\section{Futebol de Robôs}
 ...
 \end{itemize}
Uma otima descriçao do ambiente de futebol de robos é descrita por \cite{Faria2006}, e pode ser vista na Figura \ref{VSSS}:
\begin{quotation}
