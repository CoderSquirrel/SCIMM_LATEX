...
\subsection{??}
\cite{Neura:2009} em artigo do IX Simposio Brasileiro de Inteligencia Artificial descreve uma abordagem de detecção em tempo real utilizando redes neurais MLP, Perceptron de Multiplas Camadas.
